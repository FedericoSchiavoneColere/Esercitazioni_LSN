...
public:
    ...
    vector<int> Worst_n_index(int n);
    void Show(int tt);
    void SwapBxW(vector<int> B); //scmbia la lista peggiore con quella passata
...
//Lista Figlia2(Lista l1, Lista l2, double r, double rr);
